...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [1] = LAYOUT(
    ...
    KC_INS,  KC_TAB,  KC_VOLD, KC_UP,   KC_VOLU, KC_SLCK, KC_PAUS, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_PMNS, KC_LANG2, KC_LANG1,
    ...
    KC_PSCR, KC_MSTP, KC_MPRV, KC_MPLY, KC_MNXT, KC_END , KC_PGDN, KC_P1, KC_P2, KC_P3, KC_PAST, KC_PSLS, TG(3),
                      KC_NLCK, KC_TRNS, KC_P0,   KC_PDOT, MO(2)
  ),

  /* Layer 2
    |------+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+------+------|
    | RCtl | Hom | Bak | Fwd | Stp | Ref | Sch | Fav | MyC | Mai | Hlp |     |     |      | Calc |
    |------+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+------+------|
  ...
  */
  [2] = LAYOUT(
    KC_RCTL, KC_WHOM, KC_WBAK, KC_WFWD, KC_WSTP, KC_WREF, KC_WSCH, KC_WFAV, KC_MYCM, KC_MAIL, KC_HELP, KC_NO,   KC_NO,  KC_NO, KC_CALC,
  ...
  */
  [3] = LAYOUT(
    ...
    KC_NO,   KC_NO,   KC_BTN2, KC_MS_U, KC_BTN1, KC_BTN4, KC_BTN5, KC_BTN3, KC_WH_U, KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,
    KC_NO,   KC_NO,   KC_MS_L, KC_MS_D, KC_MS_R, KC_NO,   KC_NO,   KC_WH_L, KC_WH_D, KC_WH_R, KC_NO,  KC_NO,  KC_NO,
    KC_NO,   KC_ACL0, KC_ACL1, KC_ACL2, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,  MO(3),
                    KC_NO, TG(1), KC_NO, KC_NO, TG(2)
  )
};